...
namespace Example_julian.Datos
{
    internal class HelperDao
    {
        private static HelperDao instancia;
        private SqlConnection cnn = new SqlConnection(@"Data Source=DESKTOP-E5DB0VI;Initial Catalog=UsuariosExample;Integrated Security=True;Encrypt=False");
